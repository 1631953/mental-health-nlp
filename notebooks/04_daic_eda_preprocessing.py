...
"""**Word Count:** Shows a right-skewed distribution — most statements are around 1,000 characters, which matches the max of the kaggle dataset. This makes sense, considering it's not posts anymore."""
